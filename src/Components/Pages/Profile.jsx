                    ...
                    <div className="py-12 px-24 md:gap-8 gap-5 items-center flex flex-col rounded-lg border border-pink-700">
                        <div className="flex md:gap-2 gap-5 md:flex-row flex-col ">
                            ...
                            <div className=" flex flex-col gap-2">
                                ...
                                <input type="text" className="border-2 rounded-lg border-purple-600 dark:bg-zinc-800 h-12 dark:text-white font-thin w-64" id="lastname" onChange={(e)=>onChangeHandler("lastname", e.target.value)} />
                            </div>
                        </div>
                        <div className=" flex flex-col gap-2">
                            <label htmlFor="lastname" className="dark:text-white font-semibold text-lg">&nbsp; Email </label>
                            <input type="text" className="border-2 rounded-lg border-purple-600 dark:bg-zinc-800 h-12 dark:text-white font-thin md:w-[520px] w-64" id="email" value={data.email} disabled />
                        </div>
                        <div className=" flex flex-col gap-2">
                            <label htmlFor="lastname" className="dark:text-white font-semibold text-lg">&nbsp; Birthday </label>
                            <input type="date" className="border-2 rounded-lg border-purple-600 dark:bg-zinc-800 h-12 dark:text-white font-thin md:w-[520px] w-64" id="birthday" onChange={(e)=>onChangeHandler("birthday", e.target.value)} />
                        </div>
